    ...
    `}>
      ...
      <div className='w-full flex justify-between items-center
       ...
       border-t-[1px] border-t-[#3f3e45]'>
        <p className='flex flex-row items-center font-poppins font-normal text-center
         text-[18px] leading-[27px] text-white'>
          {new Date().getFullYear()} AnasTafish. All Rights Reserved.
           <span><a target={'_blank'} rel="noreferrer" href="https://github.com/anastafish">
             <img src={github} alt="github"
             className='w-[21px] h-[21px] object-contain
              cursor-pointer mx-2 bg-white rounded-full'/>
           </a></span>
