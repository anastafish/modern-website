...
const Billing = () =>(
    <section id='product' className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <div className='flex flex-row flex-wrap sm-10 mt-6'>
          <img src={apple} alt="app-store" 
          className='w-[128px] h-[42px] objext-contain mr-5 cursor-pointer'/>
          <img src={google} alt="google-play" 
          className='w-[128px] h-[42px] objext-contain cursor-pointer'/>
        </div>          
      </div>
    </section>
  )
